...
class WaterComponent : public SpriteComponent, public TransformableComponent, public CollisionObserver
{
public:
	explicit WaterComponent(std::shared_ptr<GameObject> parent, Layer layer, sf::Texture& texture);
